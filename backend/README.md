...
| **Community** | Tavily (web search), SearXNG (self-hosted metasearch), Jina AI (web fetch), Firecrawl (scraping), Steel Browser (screenshot/PDF/session capture), DuckDuckGo (image search) |
